    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    customerLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    jobTitle = table.Column<string>(maxLength: 20, nullable: false),
                    customerId = table.Column<int>(maxLength: 38, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    vendorLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    jobTitle = table.Column<string>(maxLength: 20, nullable: false),
                    vendorId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    branchFrombranchId = table.Column<int>(nullable: true),
                    warehouseIdFrom = table.Column<int>(nullable: false),
                    warehouseFromwarehouseId = table.Column<int>(nullable: true),
                    branchIdTo = table.Column<string>(maxLength: 38, nullable: true),
                    branchTobranchId = table.Column<int>(nullable: true),
                    warehouseIdTo = table.Column<int>(nullable: false),
                    warehouseTowarehouseId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    salesOrderLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    salesOrderId = table.Column<int>(maxLength: 38, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    createdAt = table.Column<DateTime>(nullable: false),
                    HasChild = table.Column<string>(nullable: true),
                    purchaseOrderId = table.Column<int>(maxLength: 38, nullable: false),
                    receivingNumber = table.Column<string>(maxLength: 20, nullable: false),
                    receivingDate = table.Column<DateTime>(nullable: false),
                    vendorId = table.Column<int>(maxLength: 38, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    transferInId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    HasChild = table.Column<string>(nullable: true),
                    transferOrderId = table.Column<int>(nullable: false),
                    ...
                    description = table.Column<string>(maxLength: 100, nullable: false),
                    branchIdFrom = table.Column<int>(nullable: false),
                    branchFrombranchId = table.Column<int>(nullable: true),
                    warehouseIdFrom = table.Column<int>(nullable: false),
                    warehouseFromwarehouseId = table.Column<int>(nullable: true),
                    branchIdTo = table.Column<string>(maxLength: 38, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    transferOrderLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    transferOrderId = table.Column<int>(nullable: false),
                    productId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    transferOutId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    HasChild = table.Column<string>(nullable: true),
                    transferOrderId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    shipmentLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    shipmentId = table.Column<int>(nullable: false),
                    branchId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    receivingLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    receivingId = table.Column<int>(maxLength: 38, nullable: false),
                    branchId = table.Column<int>(nullable: false),
                    warehouseId = table.Column<int>(nullable: false),
                    productId = table.Column<int>(nullable: false),
                    qty = table.Column<float>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    transferInLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    transferInId = table.Column<int>(nullable: false),
                    productId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    transferOutLineId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    createdAt = table.Column<DateTime>(nullable: false),
                    transferOutId = table.Column<int>(nullable: false),
                    productId = table.Column<int>(nullable: false),
