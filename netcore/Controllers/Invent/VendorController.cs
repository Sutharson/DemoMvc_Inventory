...
namespace netcore.Controllers.Invent
{
    ...
    public class VendorController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("vendorId,vendorName,description,size,street1,street2,city,province,country,HasChild,createdAt")] Vendor vendor)
        {
