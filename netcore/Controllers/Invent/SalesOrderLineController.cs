...
namespace netcore.Controllers.Invent
{
    ...
    public class SalesOrderLineController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("salesOrderLineId,salesOrderId,productId,qty,price,discountAmount,totalAmount,createdAt")] SalesOrderLine salesOrderLine)
        {
