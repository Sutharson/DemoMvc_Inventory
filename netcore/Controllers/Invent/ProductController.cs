...
namespace netcore.Controllers.Invent
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("productId,productCode,productName,description,barcode,serialNumber,productType,uom,createdAt")] Product product)
        {
