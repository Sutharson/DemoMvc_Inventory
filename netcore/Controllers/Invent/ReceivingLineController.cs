...
namespace netcore.Controllers.Invent
{
    ...
    public class ReceivingLineController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("receivingLineId,receivingId,branchId,warehouseId,productId,qty,qtyReceive,qtyInventory,createdAt")] ReceivingLine receivingLine)
        {
        ...
        private bool ReceivingLineExists(int id)
        {
