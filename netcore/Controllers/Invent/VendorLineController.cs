...
namespace netcore.Controllers.Invent
{
    ...
    public IActionResult Create(int masterid, int id)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("vendorLineId,jobTitle,vendorId,firstName,lastName,middleName,nickName,gender,salutation,mobilePhone,officePhone,fax,personalEmail,workEmail,createdAt")] VendorLine vendorLine)
    {
    ...
    private bool VendorLineExists(int id)
    {
