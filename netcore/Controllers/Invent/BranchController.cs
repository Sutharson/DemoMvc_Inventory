...
namespace netcore.Controllers.Invent
{
    ...
    public class BranchController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("branchName,description,street1,street2,city,province,country,createdAt,isDefaultBranch")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("branchId,branchName,description,street1,street2,city,province,country,createdAt,isDefaultBranch")] Branch branch)
        {
