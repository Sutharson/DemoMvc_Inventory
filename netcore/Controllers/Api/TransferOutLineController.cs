...
namespace netcore.Controllers.Api
{
    ...
    public class TransferOutLineController : Controller
    {
        ...
        [HttpGet]
        [Authorize]
        public IActionResult GetTransferOutLine(int masterid)
        {
        ...
        public async Task<IActionResult> PostTransferOutLine([FromBody] TransferOutLine transferOutLine)
        {
            ...
            if (transferOutLine.transferOutLineId == 0)
            {
                Random rnd = new Random();
                transferOutLine.transferOutLineId = rnd.Next(1, 13);
        ...
        [HttpDelete("{id}")]
        [Authorize]
        public async Task<IActionResult>  DeleteTransferOutLine([FromRoute] int id)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        private bool TransferOutLineExists(int id)
        {
